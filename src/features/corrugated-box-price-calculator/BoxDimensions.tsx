      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-start">
        ...
        <div className="sm:col-span-1">
          <div className="space-y-2">
            <LabelInput label="SIZE" value={fmt(deckleSize)} onChange={(e) => onDeckleSizeChange(e.target.value)} isBold />
            <LabelInput label="DECKLE L" value={fmt(deckleLength)} onChange={(e) => onDeckleLengthChange(e.target.value)} isBold />
          </div>
        </div>
      </div>
    </section>

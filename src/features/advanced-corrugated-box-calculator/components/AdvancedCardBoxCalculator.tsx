...
const AdvancedCardBoxCalculator: React.FC = () => {
  ...
  const [cFluteGsm, setCFluteGsm] = useState<AdvancedNumericValue>(120);
  const [cFluteBF, setCFluteBF] = useState<AdvancedNumericValue>(16);
  const [cLinerGsm, setCLinerGsm] = useState<AdvancedNumericValue>(120);
  const [cLinerBF, setCLinerBF] = useState<AdvancedNumericValue>(16);
  const [aFluteGsm, setAFluteGsm] = useState<AdvancedNumericValue>(120);
  ...
  const resetAll = () => {
    ...
    setCFluteGsm(120); setCFluteBF(16);
